...
.testi-content {
    ...
    padding: 50px;
    border-radius: 6px;
    box-shadow: 1px 2px 60px 0px rgb(0 0 0 / 4%);
}
.testi-content p {
    font-size: 18px;
    font-weight: 600;
...
<section class="testimonial-sec">
	<div class="container-fluid">
		<div class="testimonial-inner">
			<div class="sec-custom-title">
				<span class="title-name">TESTIMONIALS</span>
				<h2>Customer Accolades</h2>
			</div>
				...
				<div class="testi-item">
					<div class="testi-content">
						...
						<div class="testi-img">
							...
							<div>
								<h3><?php echo $name_text; ?></h3>
								<span><?php echo $text_position; ?></span>
							</div>
						</div>
					</div>
				</div>
...
add_shortcode('resturants-tags', 'wpb_tag_shortcode');
